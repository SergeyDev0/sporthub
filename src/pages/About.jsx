            ...
            <main className={styles.main}>
                <section className={`${styles.aboutSectionText} section`}>
                    ...
                    <p className={styles.aboutText}>
                        ...
                        для всех, кто увлечен спортом. У нас Вы можете
                        узнать обо всех значимых чемпионатах, соревнованиях,
                        сроках проведения, количестве участников, местоположении
                        и многом другом. Удобная система фильтров позволяет
                ...
                <section className={styles.mission}>
                    <div className={styles.missionWrapper}>
	                    ...
	                    <p className={styles.aboutText}>
	                        Приносить пользу людям, помогая делать мир вокруг себя
	                        лучше
	                    </p>
	                    <ul className={styles.missionList}>
	                        ...
	                        <li className={styles.missionItem}>
	                            ...
	                            <h3>Эффективность</h3>
	                            <p>Быть прибыльной и быстрорастущей компанией</p>
	                        </li>
	                    </ul>
                    </div>
                </section>
                <section className="`${styles.aboutTeam} section`">                    
                    ...
                    <ul className={styles.teamList}>
						{
							DEVS.map((item, index) => (
								<li className={`${styles.teamItem}` + (item.captain ? ` ${styles.captain}` : "")} key={index}>
