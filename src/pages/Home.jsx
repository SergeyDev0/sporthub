...
const Home = () => {
    ...
    const isActiveFilterBtnFirst =
        isActiveFilterButton === 1 ? styles.active : "";
    const isActiveFilterBtnSecond =
        isActiveFilterButton === 2 ? styles.active : "";
    const isActiveFilterBtnThirsdd =
        isActiveFilterButton === 3 ? styles.active : "";
    const isActiveFilterBtnFourth =
        isActiveFilterButton === 4 ? styles.active : "";
